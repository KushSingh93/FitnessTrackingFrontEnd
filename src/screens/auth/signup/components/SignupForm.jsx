...
const SignupForm = ({ name, email, password, error, loading, handleChange, handleSignup, logo }) => {
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-indigo-600 to-purple-700">
      <div className="bg-gray-900 text-white p-8 rounded-lg shadow-lg w-96">
        ...
        <InputField type="text" name="name" placeholder="Name" value={name} onChange={handleChange} />
        <InputField type="email" name="email" placeholder="Email" value={email} onChange={handleChange} />
